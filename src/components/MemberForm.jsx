...
export default function MemberForm({ setSimilarPeople, setSuggestedEvents, setLoading}) {
    ...
    const [formData, setFormData] = useState({
        Name: "",
        About_Me: "(Click to edit) I am outgoing and love meeting new people. I am enthusiastic about electronic music, skateboarding, dancing, and running. I am a night owl, have a creative mindset, and love my work as a data scientist. ",
        Outgoing: 2,
        Outdoorsy: 2,
        Religion: "Other",
    ...
    const handleSubmit = async (e) =>{
        ...
        try {
            const response = await fetch('https://pair-recommender-service-6oqt6.ondigitalocean.app/api/submithello', {
            method: 'POST',
            headers: {
