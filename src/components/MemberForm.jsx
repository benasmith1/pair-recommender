...
export default function MemberForm({ setSimilarPeople, setSuggestedEvents, setLoading}) {
    ...
    const [formData, setFormData] = useState({
        Name: "",
        About_Me: "(Click to edit) I love meeting new people, am creative and analytical. I am enthusiastic about electronic music, skateboarding, dancing, cooking, and running. I am a night owl, have a creative mindset, and love my work as a data scientist. I like board games, puzzles, fishing, and walking around.",
        Outgoing: 2,
        Outdoorsy: 2,
        Religion: "Other",
